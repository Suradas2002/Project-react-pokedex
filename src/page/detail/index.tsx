...
const DetailPage = () =>{
    ...
    const response = await pokemonDetailServices.getPokemonDetail(name)   
       ...
       setPokemon({data:{...response.data,image:response.data.sprites.other.dream_world.front_default || response.data.sprites.other['official-artwork'].front_default}
       ,loading: false,error: null })
       


       }else{
        setPokemon({data:response.data,loading: false,error: response.error || null, })
       }
    ...
    return (
        <div className=" w-[90%] m-[auto] max-w-[1100px]">
            ...
            <div className=" w-[90%] max-w-[600px] m-[auto] ">
                ...
                {pokemon.data &&<div className=' rounded-[20px]  dark:border-gray-700 p-[16px]   m-[auto] '>
                    <div className=" bg-center aspect-square  bg-cover rounded-[20px] relative ">
                    ...
                    <div className="pt-5 bg-[#253641]  rounded-[20px] p-[16px] ">
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-[20px] gap-y-[30px]'>
                        ...
                        <div>
                            ...
                            <div className='grid grid-cols-2 sm:grid-cols-1 gap-[10px] mt-[16px]'>
                                ...
                                return<div  className={` bg-[#4CAFEB] px-[14px] capitalize py-1 rounded-[16px] `}> {item.ability.name} </div>
                                })}
                            </div>
                        </div>
                        <div>
